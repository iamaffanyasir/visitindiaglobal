...
const UpcomingTrips = () => {
  const [destinations, setDestinations] = useState(upcomingTripsData);
  const [selectedDestination, setSelectedDestination] = useState(null);
  const [modalOpen, setModalOpen] = useState(false);

  const handleScroll = (direction) => {
    const container = document.querySelector('.upcoming-carousel');
  ...
  return (
    <div className="fd-container">
      <div className="fd-header">
        <h4 className="fd-subtitle">PLAN AHEAD</h4>
        <h2 className="fd-title">Upcoming Trips</h2>
      </div>
      ...
      <div className="fd-wrapper">
        ...
        <div className="fd-carousel upcoming-carousel">
